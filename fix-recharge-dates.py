#!/usr/bin/env python3
"""Query Supabase recharges table to inspect timestamp columns."""
import requests, json

URL = "https://uqtirisxgqmhxupncink.supabase.co/rest/v1/recharges"
...
r = requests.get(URL, headers=headers, params={"limit": "3", "order": "id.desc"})
rows = r.json()
for row in rows:
